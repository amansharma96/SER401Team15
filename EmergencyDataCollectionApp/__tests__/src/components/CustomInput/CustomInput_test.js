...
describe('CustomInput Component', () => {
    ...
    it('should display error message when isInvalid is true', () => {
        const { getByText } = setup({ isInvalid: true, errorMessage: 'Error message' });
    ...
    it('should call onChangeText when input changes', () => {
        ...
        const { getByPlaceholderText } = setup({ onChangeText: onChangeTextMock, placeholder: 'Enter text' });
    ...
    it('accepts inputProps and applies them to the input element', () => {
        const { getByTestId } = setup({ inputProps: { testID: 'custom-input', accessibilityLabel: 'custom-input' } });
    ...
    it('applies additional formControlProps to the FormControl', () => {
        ...
        const { getByTestId } = setup({ formControlProps: { testID: formControlTestId } });
