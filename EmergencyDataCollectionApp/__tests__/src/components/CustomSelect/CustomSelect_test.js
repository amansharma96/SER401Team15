...
describe('CustomSelect Component', () => {
    ...
    it('displays error message when isInvalid is true', () => {
        const { getByText } = render(
            <NativeBaseTestUtils>
            <CustomSelect items={items} onChange={mockOnChange} isInvalid={true} errorMessage="Custom error message" />
            </NativeBaseTestUtils>
        );
    ...
    it('renders label when provided', () => {
        const { getByText } = render(
            <NativeBaseTestUtils>
            <CustomSelect items={items} onChange={mockOnChange} label="Custom Label" />
            </NativeBaseTestUtils>
        );
