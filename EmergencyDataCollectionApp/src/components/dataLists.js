...
export const Hazards = [
  ...
  { label: "Major Fires and if adjoining structures are or will be affected", value: "7" },
  { label: "Flood Zones or Blockages along rivers or creeks", value: "8" },
  { label: "Hazardous Materials Leaks or Ruptures posing a health or environmental hazard", value: "9" },
  { label: "Quarantine areas due to suspected disease or outbreak", value: "10" },
