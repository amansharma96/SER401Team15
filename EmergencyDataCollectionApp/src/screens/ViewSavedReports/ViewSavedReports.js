...
import {  queryReportsByType , queryReportById} from "../../utils/Database/OfflineSQLiteDB";
import { updateModeAtom, reportTypeAtom, reportIdAtom } from "../../utils/updateAtom";
    ...
    switch (reportType) {
      case 'Hazard':
        ...
        queryReportById(reportId, (report) => {
          if (report) {
            navigation.navigate('StartNewHazardReport', { screen: 'Update Hazard Report Page', params: { report } });
          }
        });
        break;
      case 'CERT':
        ...
        queryReportById(reportId, (report) => {
          if (report) {
            ...
            navigation.navigate('CERTReportNavigation', { screen: 'Update CERT Report Page', params: { reportId } });
          }
        });
        break;
      case 'MYN':
        ...
        queryReportById(reportId, (report) => {
          if (report) {
            ...
            // Navigate to the next screen after setting the atoms
            navigation.navigate('MYNReportNavigation', { screen: 'Update MYN Report Page', params: { reportId } });
          }
        });
        break;
      default:
